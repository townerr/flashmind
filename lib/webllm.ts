import { ChatCompletionMessageParam, CreateMLCEngine, MLCEngine, InitProgressReport } from "@mlc-ai/web-llm";
...
export async function initializeEngine() {
    ...
    engine = await CreateMLCEngine("Phi-3.5-mini-instruct-q4f16_1-MLC", { initProgressCallback });
    return engine;
}
